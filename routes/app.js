...
router.post('/customerApp/login', function(req, res, next) {
    ...
    console.log("【-node-service 中接口getOpenId打印传入的req.headers--------->】", req.headers)

    console.log("【-node-service 中接口getOpenId打印传入的req.params--------->】", req.params)
    console.log("【-node-service 中接口getOpenId打印传入的req.route--------->】", req.route)    
